  ...
  return (
    <div className="min-h-screen bg-black pt-32 pb-20 px-4 md:px-12">
      <div className="max-w-2xl mx-auto">
        <Link to="/my-progress" className="inline-flex items-center gap-2 text-white/40 text-sm hover:text-white mb-8 transition-colors">
        ...
        <div className="bg-white/[0.03] border border-white/[0.06] rounded p-8 text-center">
          ...
          <div className="flex gap-3 justify-center">
            ...
            <button className="flex items-center gap-2 px-6 py-2.5 bg-white/[0.06] border border-white/10 text-white rounded text-sm font-medium hover:bg-white/10 transition-colors active:scale-95">
