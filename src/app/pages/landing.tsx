                  ...
                  <div className="bg-card p-5 flex-1 flex flex-col">
                    ...
                    <div className="grid grid-cols-3 gap-3 mt-4 pt-4 border-t border-border-subtle text-center">
                      ...
                      <div>
                        ...
                        <span className="text-xs font-semibold text-foreground">ონლაინ</span>
                      </div>
                    </div>
                  </div>
                </div>
