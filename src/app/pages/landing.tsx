      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 px-4 md:px-12 lg:px-16 max-w-3xl">
          ...
          <div className="flex items-center gap-4">
            <p className="text-sm md:text-base text-gray-300">{t.landingHeroSubtitle}</p>
            <button
              onClick={handleSignIn}
            ...
            {[
              ...
              return (
                <div key={i} className="flex items-center gap-4">
                  <Icon className="w-5 h-5 text-gray-400 flex-shrink-0" strokeWidth={1.2} />
                  <span className="text-[15px] text-gray-200">{item.text}</span>
                </div>
              );
            })}
          </div>
            ...
            {[...courses, ...courses].map((course, i) => (
              ...
              >
                ...
                <div className="mt-2">
                  ...
                  <p className="text-[11px] text-gray-400 line-clamp-1">{course.instructor}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="py-24 md:py-32 px-4 md:px-12 lg:px-16 bg-black">
        <div className="max-w-4xl mx-auto text-center space-y-8">
          ...
          <div className="flex items-center justify-center gap-6 flex-wrap">
            <span className="text-gray-400 text-sm">{t.landingPayPerCourse}</span>
            <button
              onClick={handleSignIn}
            ...
            {[
              ...
              <div key={i}>
                ...
                >
                  ...
                  <Plus className={`w-5 h-5 text-gray-500 flex-shrink-0 transition-transform duration-300 ${openFaq === i ? 'rotate-45' : ''}`} />
                </button>
                <AnimatePresence>
                  {openFaq === i && (
                    <motion.div
                    ...
                    >
                      <p className="text-sm text-gray-400 leading-relaxed pb-6">{item.a}</p>
                    </motion.div>
                  )}
                </AnimatePresence>
              </div>
      ...
      <footer className="pt-16 pb-10 px-4 md:px-12 lg:px-16 bg-black border-t border-white/[0.06]">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-8 mb-12">
            <div>
              <h4 className="text-xs text-gray-500 uppercase tracking-wider mb-4">{t.landingFooterAbout}</h4>
              <ul className="space-y-2.5">
                <li><a href="#" className="text-gray-400 hover:text-white transition-colors text-sm">{t.landingFooterAboutUs}</a></li>
                <li><a href="#" className="text-gray-400 hover:text-white transition-colors text-sm">{t.landingFooterCareers}</a></li>
                <li><a href="#" className="text-gray-400 hover:text-white transition-colors text-sm">{t.landingFooterPress}</a></li>
                <li><a href="#" className="text-gray-400 hover:text-white transition-colors text-sm">{t.landingFooterBlog}</a></li>
              </ul>
            </div>

            <div>
              <h4 className="text-xs text-gray-500 uppercase tracking-wider mb-4">{t.landingFooterSupport}</h4>
              <ul className="space-y-2.5">
                <li><a href="#" className="text-gray-400 hover:text-white transition-colors text-sm">{t.landingFooterHelpCenter}</a></li>
                <li><a href="#" className="text-gray-400 hover:text-white transition-colors text-sm">{t.landingFooterContactUs}</a></li>
                <li><a href="#" className="text-gray-400 hover:text-white transition-colors text-sm">{t.landingFooterFAQ}</a></li>
                <li><a href="#" className="text-gray-400 hover:text-white transition-colors text-sm">{t.landingFooterAccount}</a></li>
              </ul>
            </div>

            <div>
              <h4 className="text-xs text-gray-500 uppercase tracking-wider mb-4">{t.landingFooterLegal}</h4>
              <ul className="space-y-2.5">
                <li><a href="#" className="text-gray-400 hover:text-white transition-colors text-sm">{t.landingFooterTermsOfUse}</a></li>
                <li><a href="#" className="text-gray-400 hover:text-white transition-colors text-sm">{t.landingFooterPrivacyPolicy}</a></li>
                <li><a href="#" className="text-gray-400 hover:text-white transition-colors text-sm">{t.landingFooterCookiePreferences}</a></li>
                <li><a href="#" className="text-gray-400 hover:text-white transition-colors text-sm">{t.landingFooterCorporateInfo}</a></li>
              </ul>
            </div>
          </div>
          ...
          <div className="pt-8 border-t border-white/[0.06] flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-gray-600 text-xs">{t.landingFooterRights}</p>
            <div className="flex items-center gap-4">
              <span className="text-gray-500 text-xs flex items-center gap-1.5"><span className="text-sm font-bold">文A</span>{language}</span>
            </div>
          </div>
        </div>
      </footer>
