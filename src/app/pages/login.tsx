  ...
  return (
    <div className="h-screen bg-background text-foreground overflow-hidden relative">
      <div className="hidden lg:block absolute top-0 right-0 bottom-0 w-[55%]">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-l from-transparent to-overlay/50" />
      </div>
      ...
      <div className="relative z-10 h-[calc(100vh-72px)] flex items-center lg:w-[45%] px-8 md:px-16 lg:px-20">
        <div className="w-full max-w-[400px] space-y-6">
          <div>
            ...
            <p className="text-sm text-foreground-subtle">{t.loginSubtitle}</p>
          </div>
          ...
          <form onSubmit={handleEmailLogin} className="space-y-4">
            <div>
              <input
                ...
                className="w-full px-4 py-3 bg-surface-raised border border-border-muted rounded text-white text-sm placeholder-white/25 focus:outline-none focus:border-brand"
              />
            </div>
            <div>
              <input
            ...
            <button type="submit" disabled={loading || !email || !password}
              className="w-full py-3 bg-brand text-white rounded-full text-sm font-bold hover:bg-brand-hover transition-all active:scale-95 disabled:opacity-50">
          ...
          <div className="space-y-3">
            <button onClick={onLogin}
              className="w-full flex items-center justify-center gap-3 px-5 py-3.5 border border-border-muted hover:bg-surface rounded font-semibold transition-colors text-sm">
          ...
          <p className="text-[11px] text-foreground-faint leading-relaxed">
            {t.loginTermsPrefix}{' '}
            <a href="#" className="text-foreground-faint hover:text-white underline">{t.loginTermsOfService}</a>
            {' '}{t.loginTermsAnd}{' '}
            <a href="#" className="text-foreground-faint hover:text-white underline">{t.loginPrivacyPolicy}</a>
          </p>
          ...
          <div className="bg-surface border border-border-subtle rounded p-3">
            <p className="text-foreground-ghost text-[9px] select-all">tiko@brightmind.ge / Test1234!</p>
          </div>
        </div>
      </div>
    </div>
