    ...
    <div className="relative bg-white shadow-2xl rounded-sm overflow-hidden aspect-[1.414/1]">
      ...
      <div className="relative p-6 md:p-8 h-full flex flex-col">
        ...
        <div className="absolute -top-[14px] right-5 z-10" style={{ filter: 'drop-shadow(0 10px 30px rgba(0,0,0,0.2))' }}>
          <div className="w-[100px] flex flex-col items-center" style={{ height: '260px', background: 'linear-gradient(180deg, #f8f8f8 0%, #efefef 40%, #e0e0e0 80%, #cccccc 100%)', clipPath: 'polygon(0 0, 100% 0, 100% 92%, 50% 100%, 0 92%)' }}>
